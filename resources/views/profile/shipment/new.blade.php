                        ...
                        <div class="form-group mb-0">
                            <div class="col-md-12">
                                <div class="custom-control custom-radio custom-control-inline">
                                    ...
                                    <label class="custom-control-label pr-4" for="deliveryType">توسط شما</label>
                                </div>
                                <div class="custom-control custom-radio custom-control-inline">
                                    <input type="radio" value="byCompany" id="deliveryType2" name="deliveryType"
                                           class="custom-control-input">
                                    <label class="custom-control-label pr-4" for="deliveryType2">توسط شرکت</label>
                                </div>
                                <div id="deliveryType" class="form-text text-dark p-1 rounded">
